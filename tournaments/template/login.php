...
if (file_exists('userdata/'. $_SESSION["username"])) {
   $myfile = fopen('userdata/'. $_SESSION["username"], "r") or die("You are not registered for this competition. Register <a href='createuser.php'>here</a>.");
   ...
   echo 'You are not registered for this competition. Register <a href="createuser.php">here</a>.';
}
